...
class CadastraOportunidadeController extends Controller
{
    function Index(Request $request) {
        try {
            ...
            if($created_deal != typeOf(1)) {
                Log::info("Created contact: " . $created_contact);
                Log::info("Created company: " . $created_company);
                Log::info("Created deal: " . $created_deal);
            ...
            Log::info("Created deal status: " . $created_deal);
        } catch (\Throwable $th) {
